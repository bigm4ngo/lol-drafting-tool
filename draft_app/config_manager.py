...
DEFAULT_PROFILE: dict[str, Any] = {
    ...
    "background_collector": {
        # In v3.1 collection runs on the Ubuntu server; the Windows app only
        # ingests transferred bundles by default. Set this back to True if you
        # want this PC to collect directly from Riot too.
        "enabled": False,
