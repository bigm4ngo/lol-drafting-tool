...
class ChampionCatalog:
    ...
    def __init__(
        ...
        *,
        ...
        # were saved with the duplicates intact. One deterministic winner is
        # kept per id.
        ...
        # Collapse distinct-id entries that share one display name (e.g. the
        # Jade-variant block, ids 60001+, whose names duplicate classic
        # champions such as Annie or Lux). The real champion always carries the
        # lowest id, so the first record in ascending-id order wins below.
